...
//     <div>
//     <Link to="/Course">
//     <svg class="w-6 h-6 mt-34 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" transform="scale(-1,1)">
...
//     </div>
//     <div className='mt-32'>ShowCourse
//           <Link to="/Home">  <button className="fixed left-4 top-[34%] transform -translate-y-1/2 bg-yellow-400 px-4 py-10 rounded-lg shadow-lg hover:bg-yellow-500 transition flex flex-col items-center">
